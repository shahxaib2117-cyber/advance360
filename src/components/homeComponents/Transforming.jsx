    ...
    return (
        ...
        laptop:flex-row-reverse ' >
            ...
            <div className=" flex-35 phone:mt-20 ml-5 lg:ml-25 lg:pt-10 ">
                ...
                <h1 className='text-[30px] leading-8 phone:text-[40px] phone:w-[80%] phone:leading-11 text-[#1B1C67] bold-futura text-start
                lg:text-[53px] lg:leading-15 '>Transforming <br className='phone:hidden lg:flex ' />
                    <span className='text-[#0096E8] '> Technology & <br className='phone:hidden lg:flex ' />
                ...
                {/* button */}
                <Button className={" mt-5 lg:mt-7 "} lable={"Explore Now"} />
            </div>
        </div>
    )
}
