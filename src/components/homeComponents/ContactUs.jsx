    ...
    return (
        <div className='min-h-screen w-full flex justify-center items-center mt-10 '>
            <div className=" bg-gradient w-[83%] flex gap-13 rounded-[20px] p-10 mr-8 ">
                ...
                {
                    <form onSubmit={formik.handleSubmit} className="h-full w-[58.5%] ml-1 rounded-[20px] p-10 bg-[#ffffff] ">
                        ...
                        <div className="h-15 w-full flex flex-col mt-3 ">
                            ...
                            <hr className='border border-[#1B1C67] ' />
                            {
                        ...
                        <div className="h-30 w-full flex flex-col mt-3 ">
                            <Input
                                name={"message"}
                                inpType='textarea'
                                onChange={formik.handleChange}
                        ...
                        <Button type="submit" lable={`Send Message`} className={"mt-11 px-13 py-5 "} send="true" />
                    </form>
                }
