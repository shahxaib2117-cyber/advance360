...
const AdvanceSolutions = () => {
    return (
        <div className=' w-full flex flex-col pl-5 md:px-20 '>
            <div className=" w-full flex flex-col-reverse gap-10 md:flex-row ">
                <div className="flex-1 flex flex-col md:ml-5 lg:mt-30 ">
                    <div className="">
                ...
                <div className=" w-full! flex flex-col gap-y-5 
                 ...
                 lg:w-[70%]! lg:flex lg:gap-x-20 lg:gap-y-0! lg:self-center">
                    {logos.map((data, index) => (
                        <img key={index} src={data.logo} className={`${[1, 3].includes(index) && "ml-10 m_phone:ml-0 phone:ml-10 tablet:ml-35 lg:ml-0 "}
